# 2026-06-12 — cabinet compile wall 30.0 → 10.6 s (web, −64%)
...
**29.96 → 10.64 s** (JSONs `docs/benches/compile-only-2026-06-12-
fnfast-{baseline,final}.json`). Every step verified byte-identical
