// Miscellaneous CPU instructions: HLT/NOP, the string ops (LODS/STOS/MOVS/
// CMPS/SCAS + their REP plumbing), MOV r/m imm, XCHG, POP r/m, LAHF/SAHF,
// flag manipulation, CBW/CWD, XLAT, INT3/INTO, BCD adjusts, and no-op stubs.
// The chipset (PIT/PIC/keyboard/DAC wires and the IN/OUT port handlers)
// lives in patterns/chipset.mjs.
