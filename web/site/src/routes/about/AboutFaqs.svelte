...
<div class="subpage">
  ...
  <div class="faq-list">
    ...
    <Foldable id="ai" onopen={faq('ai')}>
      ...
      <p>
      <b>Can someone make an AI that only A) teaches you, or B) automates uncreative tasks you can already do? I'd subscribe.</b> Editing website CSS manually has started to feel menial and old-timey, like hand-washing clothes. Maybe I&rsquo;ve had a taste of LLM coding, or maybe I&rsquo;ve had a taste of the depraved stuff and ordinary CSS doesn&rsquo;t turn me on any more. Either way, I want to automate centering divs and fiddling with line heights: it's not 'creative', it's an unnecessary obstruction.
      </p>
      <p>
