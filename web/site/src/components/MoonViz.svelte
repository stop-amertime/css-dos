...
<!-- earth–moon distance. The dotted walk is ~60% of the baseline:
     ...
     60.3% of the 384,400 km mean Earth–Moon distance. Baseline x=40..660. -->
<div class="moon-viz" id="moon-viz">
  <svg viewBox="0 0 700 160" role="img" aria-label="Earth to Moon distance, about 60% dotted">
    <!-- baseline -->
    <line x1="40" y1="120" x2="660" y2="120" stroke="#888" stroke-width="1" stroke-dasharray="2 4"/>
    <!-- the walk: ~60% of the way (x=40 -> x=414) -->
    <line x1="40" y1="120" x2="414" y2="120" stroke="#aa0000" stroke-width="3" stroke-dasharray="3 5"/>
    <!-- Earth -->
    ...
    <!-- ~60% marker -->
    <text x="414" y="98" text-anchor="middle" font-size="11" fill="#aa0000" font-family="inherit">~60%</text>
  </svg>
  <p class="caption">
