...
// (6) Hold a key needs NO transformation: the hold-mode checkbox is the
//     cabinet's --kbdHold wire (`&:has(#kb-holdmode:checked)`), and the
//     machine itself latches key releases while it is up — identical
//     pure-CSS behavior in both players. See kiln emitIRQCompute.
