...
; ============================================================
scancode2ascii:
    db 0x00, 0x1B, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36   ; 01 Esc, 02-07 '1'-'6'
    db 0x37, 0x38, 0x39, 0x30, 0x00, 0x00, 0x08, 0x09   ; 08-0B '7'-'0', 0E Bksp, 0F Tab
    ...
    db 0x62, 0x6E, 0x6D, 0x2C, 0x2E, 0x2F, 0x00, 0x00   ; 30-32 BNM, 33 ',' 34 '.' 35 '/'
